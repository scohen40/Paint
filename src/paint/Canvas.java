...
public class Canvas extends JComponent implements MouseListener, MouseMotionListener {
    private ArrayList<paint.Shapes.Shape> shapes = new ArrayList<>();
    ...
    public void paintShapes(Graphics g) {
        for(paint.Shapes.Shape shape : shapes) {
            shape.paintShape(g);
        }
    }
...
//        }
    ...
    public void loadImageProject(File file) throws IOException {
        ...
        try {
            shapes = (ArrayList<paint.Shapes.Shape>)(objectInputStream.readObject());
